...
We apply the DML-based methods using 5 sample splits (i.e., repeating cross-fitting 5 times by different random sample splitting) and 5 folds for cross-fitting. 
